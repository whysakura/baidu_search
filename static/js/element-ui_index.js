!function (e, t) {
    ...
    return function (e) {
        ...
        e.exports = {
            render: function () {
                ...
                return i("transition-group", {
                    ...
                    }, [i("i", {staticClass: "el-icon-document"}), e._v(e._s(t.name) + "\n    ")]), i("label", {staticClass: "el-upload-list__item-status-label"}, ["success" === t.status ? i("i", {
                        class: {
        ...
        t.default = {
            ...
            render: function (e) {
                var t = this.handleClick, i = this.drag, n = this.name, s = this.handleChange, o = this.multiple, a = this.accept, r = this.listType, l = this.uploadFiles, u = {
                    class: {"el-upload": !0},
                    on: {click: t}
                };
